...
<body>
    ...
    <div class="p-8 space-y-6">
        ...
        <h1 class="text-2xl font-bold">LAYOUT PRÓPRIO E SEM ÍCONES - CUSTOM LAYOUT AND NO ICONS</h1>
        ...
        <div class="min-h-[calc(100vh-20rem)] flex items-center justify-center">
            <div class="card shadow-md rounded-xl p-6 m-4">
                ...
                <h1 class="text-xl font-semibold">Esta página tem seu próprio layout e não importa os ícones do Tabler.</h1>
                <p>
                    Se após a instalação os ícones não aparecerem, provavelmente você não incluiu a stylesheet:
                </p>
            ...
            <div class="card shadow-md rounded-xl p-6 m-4">
                ...
                <h1 class="text-xl font-semibold">This page has its own layout and does not import the Tabler icons.</h1>
                <p>
                    If the icons don't appear after installation, you probably haven't included the stylesheet:
                </p>
                <a target="_blank" href="https://tabler.io/icons" class="text-blue-600 hover:underline">
                    https://cdn.jsdelivr.net/npm/@tabler/icons-webfont@latest/dist/tabler-icons.min.css
                </a>             
